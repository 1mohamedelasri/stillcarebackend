...
public class UniteController {
    ...
    /*@GetMapping("/unites/ehpad/{idephad}")
    List<UniteEntity> findOtherUniteOfResidentByEphad( @PathVariable Long idephad) {
        return repository.findOtherUniteOfResidentByEphad(idephad)
