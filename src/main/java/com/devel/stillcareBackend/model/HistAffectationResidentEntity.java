...
@Entity
@Table(name = "HIST_AFFECTATION_RESIDENT")
@IdClass(HistAffectationResidentEntityPK.class)
public class HistAffectationResidentEntity {
    ...
    public boolean equals(Object o) {
        ...
        HistAffectationResidentEntity that = (HistAffectationResidentEntity) o;
